...
function NoiseLine(opts) {
    ...
    this.timeScale = JC.random(0.8, 1.4);
}
...
documentLink.on('click',function(){
    window.location.href = 'https://jasonchen1982.github.io/jcc2d/docs/';
})
...
examplesLink.on('click',function(){
    window.location.href = 'https://jasonchen1982.github.io/jcc2d/examples/';
})
